...
const backgrounds = [
  'url("/assets/Cyberpunk2077-Evening.jpg")',
  'url("/assets/Cyberpunk2077-Watson.jpg")',
  'url("/assets/Cyberpunk2077-Westbrook.jpg")',
  'url("/assets/flat-DS1.jpg")',
  'url("/assets/Waterfall-DS1.jpg")',
  // Add more background URLs
]
